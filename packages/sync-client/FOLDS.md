...
| `kitchen_queue` | counter_electron, counter_rn, kitchen, manager | `queue(order_id PK, confirm_at, channel, age_basis, lines_ready, lines_total)` | order.confirmed, order.line_state_changed, kot.printed |
