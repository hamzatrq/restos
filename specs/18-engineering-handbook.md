...
- **Money/quantities:** branded integer types (`Paisa`, `Milligrams`, `Millilitres`) in `domain` with arithmetic helpers; raw `number` arithmetic on money is banned by convention + review; NEVER floats (00 §6).
