 ...
 *
 * `Workspace` is the two sections behind that one route — the menu (`14-F5`..`14-F29`) and the
 * devices (`14-F12`/`14-F13`). Why a tab rather than a second route is recorded in that file.
 */
